...
echo "<div class='container-fluid'>";
	...
	echo "<div class='row'>";
		...
		$result = $conexion->query($sql);
			...
			echo "<p>Filtrar: <input type='text' class='myBtnInputTex' id='myInput01' onkeyup='filterTable(0)' placeholder='Buscar...' title='Filtrar por folio...'/></p>";
			
			$buttons = array(array('Ver Remisiones', 'btn btn-primary', "<span class='glyphicon glyphicon-eye-open'></span>&nbsp;&nbsp;&nbsp;Ver remisiones"));
			$form = array('folios.php','');
	...
	echo "<br><div class='row'>";
		...
		echo "<div class='col-xs-4'>";
			echo "<div class='text-right'>";
				echo "<button type='button' onclick=\"window.location='indexTransportista.php';\"; class='btn btn-danger btn-lg'><span class='glyphicon glyphicon-menu-left'></span>&nbsp;Volver";
			echo "</div>";
		echo "</div>";
		echo "<div class='col-xs-4'>";
		echo "</div>";
